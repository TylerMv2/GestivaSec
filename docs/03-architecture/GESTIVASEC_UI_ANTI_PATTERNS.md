...
**Document Status:** `APPROVED & STRICTLY ENFORCED MANUAL`  
...
This manual documents every forbidden UI and UX anti-pattern in **Gestiva Security**. Violating these rules will result in automatic rejection during Architecture Review Board (ARB) code reviews.
